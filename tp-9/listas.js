...
function calcularPromedio(listaDeNumeros) {
    let prom = 0;
    for(let i = 0; i<listaDeNumeros.length; i++){
        prom += listaDeNumeros[i]
    }
    return prom/3;
}
console.log("calcularPromedio([2,3,4]): ", calcularPromedio([2,3,4]))
console.log("calcularPromedio(listaNumerosEjemplo): ", calcularPromedio([2,3,4]))
...
console.log("crearListaDeNumeros(2,5): ", crearListaDeNumeros(2,2))
...
function ordenarDeMayorAMenor(listaDeNumeros) {
    listaDeNumeros = listaDeNumeros.sort()
    return listaDeNumeros.reverse()
}
console.log("ordenarDeMayorAMenor([2,3,4]): ", ordenarDeMayorAMenor([2,3,4]))
console.log("ordenarDeMayorAMenor(listaNumerosEjemplo): ", ordenarDeMayorAMenor([2,-1,4]))
...
function filtrarSoloPositivos(listaDeNumeros) {
    let numPositivos = ([]);
    for(let i = 0;i<listaDeNumeros.length;i++){
        if(0 <= listaDeNumeros[i]){
            numPositivos.push(listaDeNumeros[i]);
        }
    }
    return numPositivos;
}
...
function enumerarLista(listaDePalabras) {
    return listaDePalabras.slice(0, listaDePalabras.length).join(", ");
}
